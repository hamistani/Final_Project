# Generated by Django 4.2.17 on 2024-12-12 07:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barking_level', models.PositiveIntegerField()),
                ('mental_stimulation', models.PositiveIntegerField()),
                ('breed_name', models.OneToOneField(db_column='breed_name', on_delete=django.db.models.deletion.CASCADE, related_name='traits', to='dog_breed_preference.breed')),
            ],
        ),
        migrations.CreateModel(
            name='BreedRank',
            fields=[
                ...
                ('breed_name', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='rank', to='dog_breed_preference.breed')),
            ],
        ),
    ]
